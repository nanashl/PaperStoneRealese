...
namespace Managers
{
    public class GameManagerRoulet : MonoBehaviour
    {
        ...
        public static GameManagerRoulet Instance; // A static reference to the GameManager instance
        ...
        private async Task StartRouletteGame()
        {
            ...
            characterTable.characterMoney.characterMoney.Value = Convert.ToInt32(ExitEsc.score);
